...
(( $+functions[sf_tui_format_notice] )) || source "$SF_ROOT/libexec/tui/render/notices.zsh"
(( $+functions[sf_tui_format_execution_block] )) || source "$SF_ROOT/libexec/tui/render/execution.zsh"
