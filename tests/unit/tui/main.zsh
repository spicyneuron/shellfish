...
typeset seen_session='' seen_runtime='' seen_presentation='' seen_initial=''
...
sf_tui_run /sessions/open.jsonl '{"resolved":true}' '{"theme":"dark"}' prompt startup sketch 0
assert_equal /sessions/open.jsonl "$seen_session"
assert_equal '{"resolved":true}' "$seen_runtime"
