...
sf_tui_add message user '' 'alpha beta gamma'
COLUMNS=12
LINES=10
sf_tui_repaint
    ...
    for split in 0 1; do
      for width in 12 30; do
        for highlight in 0 1; do
          ...
          sf_tui_repaint || fail "cannot render tool after $detail"
...
sf_tui_add reasoning agent '' 'thought' open
COLUMNS=30
sf_tui_repaint
