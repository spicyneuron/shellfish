...
sf_test_source share/profiles/default/backends/_backend.zsh
sf_test_tmp backends

# Create private backend files.
sf_backend_setup test_backend
[[ $SF_BACKEND_TEMP_DIR == */shellfish-backend-test_backend.* ]]
assert_equal 700 "$(stat -f %Lp "$SF_BACKEND_TEMP_DIR")"
