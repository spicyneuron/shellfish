...
typeset run="$ROOT/share/backends/openai-responses/run"
typeset codex_run="$ROOT/share/backends/codex/run"
typeset codex_context_window="$ROOT/share/backends/codex/context_window"
