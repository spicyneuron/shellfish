...
typeset shell_command='[[ -n $HOME ]] || exit 8; env | grep -Eq '\''^SHELLFISH_(SESSION|SESSION_ID|TURN_STATE|SESSION_STATE|CAPTURE_LIMIT|MODE|MODEL|TURN_ID|VERBOSE|CONFIG_DIR)='\'' && exit 9; print output; exit 7'
