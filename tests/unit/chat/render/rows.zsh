...
sf_chat_event assistant_delta xyz
sf_chat_rows 8 20
...
sf_chat_reset
sf_chat_add reasoning agent '' $'\nfirst\nsecond\n' open
sf_chat_set_frontier 1 7
sf_chat_rows 80 20
...
sf_chat_reset
sf_chat_event tool_call call_zero_denial shell 'make test'
sf_chat_event tool_result call_zero_denial 1 failure '' '' sandbox_denial
sf_chat_rows 80 20
assert_equal '╰ … · exit 1 · sandbox denial detected' "$SF_PRESENT_ROW_TEXT[-1]"
...
sf_chat_rows 8 20 "$SF_PRESENT_ROW_CURSOR[-1]"
...
sf_chat_reset
sf_chat_event system $'first row\nsecond row\nthird row'
sf_chat_rows 80 20
...
sf_chat_reset
sf_chat_event tool_call call_long shell $'first row\nsecond row'
sf_chat_event tool_result call_long hidden done
sf_chat_rows 80 20
assert_equal $'⛭ shell\n│ first row\n│ …\n╰ done' \
  "${(F)SF_PRESENT_ROW_TEXT[-4,-1]}"

sf_chat_reset
sf_chat_event tool_call call_full edit_file path
sf_chat_event tool_result call_full hidden $'one\ntwo\nthree' file_diff full
sf_chat_rows 80 20
...
sf_chat_reset
sf_chat_add message user '' $'e\u0301x'
sf_chat_rows 2 20
assert_equal $'e\u0301x' "${(F)SF_PRESENT_ROW_TEXT}"

sf_chat_reset
sf_chat_add message user '' $'abcd\u0301x'
sf_chat_rows 4 20
assert_equal $'abcd\u0301\nx' "${(F)SF_PRESENT_ROW_TEXT}"

sf_chat_reset
sf_chat_add message user '' $'a\tb'
sf_chat_rows 8 20
assert_equal $'a       \nb' "${(F)SF_PRESENT_ROW_TEXT}"

sf_chat_reset
sf_chat_add message user '' $'\tb'
sf_chat_rows 4 20
assert_equal $'    \nb' "${(F)SF_PRESENT_ROW_TEXT}"

sf_chat_reset
sf_chat_add message user '' 'comments are stripped after parsing'
sf_chat_rows 16 20
...
sf_chat_reset
sf_chat_add message user '' $'ab界e\u0301x'
...
sf_chat_reset
sf_chat_add message user '' ' hello'
sf_chat_rows 3 20
assert_equal $' he\nllo' "${(F)SF_PRESENT_ROW_TEXT}"

sf_chat_reset
sf_chat_add message user '' $'abcd\nnext'
sf_chat_rows 4 20
assert_equal $'abcd\nnext' "${(F)SF_PRESENT_ROW_TEXT}"

if sf_chat_rows 0 1; then
  fail 'accepted a zero-width viewport'
fi
if sf_chat_rows 8 1 broken; then
